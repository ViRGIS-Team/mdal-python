...
FIND_PATH(MDAL_INCLUDE_DIR mdal.h
          HINTS $ENV{LIB_DIR}/include ${PC_MDAL_INCLUDEDIR} ${PC_MDAL_INCLUDE_DIRS} ${MDAL_PREFIX}/include $ENV{PREFIX}\\Library\\include
          PATH_SUFFIXES libmdal )

message(STATUS "MDAL_INCLUDE=${MDAL_INCLUDE_DIR}")

FIND_LIBRARY(MDAL_LIBRARY NAMES mdal libmdal
             HINTS $ENV{LIB_DIR}/lib ${PC_MDAL_LIBDIR} ${PC_MDAL_LIBRARY_DIRS} ${MDAL_PREFIX}/lib $ENV{PREFIX}\\Library\\lib)
