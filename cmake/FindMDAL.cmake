...
FIND_PATH(MDAL_INCLUDE_DIR mdal.h
          PATHS $ENV{CONDA_PREFIX}/include  $ENV{LIB_DIR}/include ${PC_MDAL_INCLUDEDIR} ${PC_MDAL_INCLUDE_DIRS} $ENV{CONDA_PREFIX}\\Library\\include $ENV{PREFIX}/include
          PATH_SUFFIXES libmdal )

message(STATUS "MDAL_INCLUDE=${MDAL_INCLUDE_DIR}")

FIND_LIBRARY(MDAL_LIBRARY NAMES mdal
             PATHS $ENV{CONDA_PREFIX}/lib $ENV{LIB_DIR}/lib ${PC_MDAL_LIBDIR} ${PC_MDAL_LIBRARY_DIRS} $ENV{CONDA_PREFIX}\\Library\\lib $ENV{PREFIX}/lib)
