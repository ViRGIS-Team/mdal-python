...
FIND_PATH(MDAL_INCLUDE_DIR mdal.h
          HINTS ${MDAL_PREFIX}/include ${MDAL_PREFIX}\\Library\\include $ENV{LIB_DIR}/include ${PC_MDAL_INCLUDEDIR} ${PC_MDAL_INCLUDE_DIRS} $ENV{PREFIX}\\Library\\include $ENV{PREFIX}/include
          PATH_SUFFIXES libmdal )

message(STATUS "MDAL_INCLUDE=${MDAL_INCLUDE_DIR}")

FIND_LIBRARY(MDAL_LIBRARY NAMES mdal
             HINTS ${MDAL_PREFIX}/lib $ENV{LIB_DIR}/lib ${PC_MDAL_LIBDIR} ${PC_MDAL_LIBRARY_DIRS} $ENV{PREFIX}\\Library\\lib $ENV{PREFIX}/lib)
